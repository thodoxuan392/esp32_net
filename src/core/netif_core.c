...
static const char * at_response_table[NETIF_RESPONSE_MAX] = {
	...
	[NETIF_WIFI_ETHERNET_REPORT_TCP_CIP_START_CONNECT] = "CONNECT",
    [NETIF_WIFI_ETHERNET_REPORT_TCP_CIP_CLOSED] = "CLOSED",
    [NETIF_WIFI_ETHERNET_REPORT_TCP_CIP_RECV_DATA] = "+CIPRECVDATA:",
#endif
#if defined(NETIF_4G_ENABLE) && NETIF_4G_ENABLE == 1
	[NETIF_4G_REPORT_SMS_DONE] = "SMS DONE",
    [NETIF_4G_REPORT_INITIALIZE_DONE] = "PB DONE",
	[NETIF_4G_REPORT_ICCID] = "+ICCID: ",
	[NETIF_4G_REPORT_CSQ] = "+CSQ: ",
	...
	[NETIF_4G_REPORT_TCP_NET_OPEN] = "+NETOPEN:",
    [NETIF_4G_REPORT_TCP_NET_CLOSE] = "+NETCLOSE:",
    [NETIF_4G_REPORT_TCP_CIP_OPEN] = "+CIPOPEN:",
	...
	[NETIF_4G_REPORT_HTTP_ACTION] = "+HTTPACTION:",
	[NETIF_4G_REPORT_HTTP_READ] = "+HTTPREAD:",
#endif
